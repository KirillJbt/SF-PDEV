...
class Ship:
    ...
    ----------
        ...
        health: int
            Количество жизней корабля. В начале игры соответствует длине корабля.
...
class Board:
    ...
    def add_ship(self, ship: Ship) -> None:
        ...
        Args:
            ship (Ship): Корабль, экземпляр класса Ship.
...
class Player:
    ...
    -------    
        ...
        move()
            Делает ход игрока. Возвращает True, если этому игроку нужен повторный ход,
